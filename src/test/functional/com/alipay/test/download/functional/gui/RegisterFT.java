package com.alipay.test.download.functional.gui;

import static org.junit.Assert.*;

import org.junit.Test;
import org.openqa.selenium.By;
import com.alipay.test.download.functional.BaseSeleniumTestCase;
...
public class RegisterFT extends BaseSeleniumTestCase {
	...
	public void register() {
		...
		//跳转到登录页
		assertEquals("download示例:登录页", s.getTitle());
		...
		//登陆成功
		assertEquals("download示例:任务管理", s.getTitle());
